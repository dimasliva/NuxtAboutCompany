<template>
    <v-hover v-slot="{ isHovering, props }" open-delay="200">
        <div  v-bind="props">
            <NuxtLink v-if="isMore" to="https://siams.com/" target="_blank" class="flex justify-center items-center p-0 cursor-pointer" :class="[isMore ? styles.teamItem + ' justify-center items-center bg-[#050505]' : styles.teamItem + ' items-end']">
                <EntityHomeUiHomeLinkArrow text="Узнать больше" link="https://siams.com/" />
            </NuxtLink>
            <div v-else :class="[isMore ? styles.teamItem + ' justify-center items-center bg-[#050505]' : styles.teamItem + ' items-end']">
